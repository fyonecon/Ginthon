...
<section class="section-side_search select-none bg-neutral-200 dark:bg-neutral-800">
    <div class="side-search font-text">
        <label class="label">
            <input class="side-search-input input-style w-full border-radius font-text select-text bg-white dark:bg-surface-900" type="search" maxlength="2000" placeholder="{func.get_translate('input_placeholder_search')}"
