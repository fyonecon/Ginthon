                ...
                <li class="list-path-tree-li list-path-tree-li-dir border-radius">
                    ...
                    <div class="list-path-tree-li-content">
                        ...
                        <div class="li-name font-text break">
                            <button class="list-path-tree-li-btn click break select-text" type="button" title="{the_dir_info.name}" onclick={()=>func.open_url(config.sys.base_route+"/play_audio"+"?dir="+encodeURIComponent(func.converted_path(view_path+"/"+the_dir_info.name)))} >{the_dir_info.name}</button>
                        </div>
                        <!---->
