...
from internal.common.view_auth import make_view_auth, make_rand_id
...
# 视窗view-url
def view_url():
    _view_url = CONFIG["pywebview"]["view_url"]
    rand_id = make_rand_id(CONFIG)
    view_auth = make_view_auth(CONFIG)
    url = _view_url+ "/" + rand_id + "?" + "view_auth=" + view_auth + "&version=" + CONFIG["app"]["app_version"] + "&ap=" + CONFIG["app"][ "app_name"]
    #
    return url
